 ...
 * appended the new Action, "ACTION_MIGRATE"
 */
...
public class Intent implements Parcelable, Cloneable {
    ...
    public static final String ACTION_MIGRATE = "android.intent.action.MIGRATE";
    public static final String ACTION_STACKED = "android.intent.action.STACKED";

 ...
 * MigratorService is registered to SystemServer
 *
 */
    ...
    public void initAndLoop() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (true) {
                ...
                try {
                  Slog.i(TAG, "Migrator Service");
                  ServiceManager.addService("Migrator", new MigratorService(context));
                } catch (Throwable e) {
                  Slog.e(TAG, "Failure starting MigratorService Service", e);
                }
            }
        }
